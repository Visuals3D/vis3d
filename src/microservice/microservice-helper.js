...
const replaceableVarsFilesList = ['package.json', 'insomnia.yaml', 'preset.env', 'docker-compose.yml', 'README.md', 'spc_5504ff4ccd1c4ef491f21b0e87c78ed6.yml', 'wrk_26fa530600ea45e298aacb902b4a8253.yml'];
